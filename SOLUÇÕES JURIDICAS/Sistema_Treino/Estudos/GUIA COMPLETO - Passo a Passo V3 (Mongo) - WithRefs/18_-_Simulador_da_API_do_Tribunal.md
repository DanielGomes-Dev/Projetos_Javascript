...
Este passo não depende de nenhuma biblioteca externa (é só JavaScript/TypeScript puro simulando uma integração). As referências relevantes são da própria linguagem:
