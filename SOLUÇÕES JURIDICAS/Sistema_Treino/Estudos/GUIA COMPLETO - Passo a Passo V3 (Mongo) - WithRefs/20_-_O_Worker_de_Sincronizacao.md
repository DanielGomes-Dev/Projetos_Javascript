...
import { Lawsuit } from '../models/index.js';
...
- **BullMQ — Retries e backoff exponencial**: https://docs.bullmq.io/guide/retrying-failing-jobs
- **BullMQ — encerramento gracioso (`Worker.close()`)**: https://docs.bullmq.io/guide/workers/graceful-shutdown
- **MongoDB Manual — atomicidade por documento**: https://www.mongodb.com/docs/manual/core/write-operations-atomicity/
