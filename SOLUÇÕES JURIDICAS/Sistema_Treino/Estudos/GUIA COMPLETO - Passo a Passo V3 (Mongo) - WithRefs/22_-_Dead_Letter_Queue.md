...
- **Mongoose — índices via `schema.index()`**: https://mongoosejs.com/docs/guide.html#indexes
- **BullMQ — evento `failed` do Worker**: https://docs.bullmq.io/guide/workers
- **BullMQ — Retries e esgotamento de tentativas**: https://docs.bullmq.io/guide/retrying-failing-jobs
- **Mongoose — nomeação automática de coleções (pluralização)**: https://mongoosejs.com/docs/models.html#compiling
