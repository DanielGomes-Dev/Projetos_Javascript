...
- **TypeScript — referência completa do `tsconfig.json`**: https://www.typescriptlang.org/tsconfig
- **TypeScript — módulos `NodeNext`/ESM**: https://www.typescriptlang.org/docs/handbook/modules/reference.html
- **tsx — execução de TypeScript sem build prévio**: https://tsx.is/
