...
- **BullMQ — `QueueEvents`**: https://docs.bullmq.io/guide/events
- **BullMQ — evento `completed` e `returnvalue`**: https://docs.bullmq.io/guide/events
- **Socket.IO — emitindo para uma sala (`.to()`)**: https://socket.io/docs/v4/rooms/#emitting-to-a-room
