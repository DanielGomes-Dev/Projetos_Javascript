...
- **Imagem oficial `mongo` no Docker Hub**: https://hub.docker.com/_/mongo
- **MongoDB Manual — documentação geral**: https://www.mongodb.com/docs/manual/
- **Docker Compose — `healthcheck`**: https://docs.docker.com/reference/compose-file/services/#healthcheck
- **Docker Compose — `depends_on` com `condition`**: https://docs.docker.com/reference/compose-file/services/#depends_on
