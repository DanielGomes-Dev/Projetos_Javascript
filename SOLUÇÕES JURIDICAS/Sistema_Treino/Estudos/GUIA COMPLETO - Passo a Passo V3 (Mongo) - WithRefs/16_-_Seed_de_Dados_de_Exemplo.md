...
- **Mongoose — Models (`create`, `deleteMany`)**: https://mongoosejs.com/docs/models.html
- **Mongoose — `Connection.asPromise()`**: https://mongoosejs.com/docs/api/connection.html#Connection.prototype.asPromise()
