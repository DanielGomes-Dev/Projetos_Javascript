...
- **ESLint — documentação geral**: https://eslint.org/docs/latest/
- **ESLint — arquivos de configuração (flat config)**: https://eslint.org/docs/latest/use/configure/configuration-files
- **typescript-eslint — documentação**: https://typescript-eslint.io/
