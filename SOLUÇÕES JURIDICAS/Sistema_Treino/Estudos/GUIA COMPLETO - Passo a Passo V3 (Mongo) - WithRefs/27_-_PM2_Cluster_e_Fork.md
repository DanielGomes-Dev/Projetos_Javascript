...
- **PM2 — documentação geral**: https://pm2.keymetrics.io/docs/usage/quick-start/
- **PM2 — modo Cluster**: https://pm2.keymetrics.io/docs/usage/cluster-mode/
- **PM2 — arquivo de configuração (`ecosystem.config`)**: https://pm2.keymetrics.io/docs/usage/application-declaration/
- **PM2 — `pm2-runtime` para containers Docker**: https://pm2.keymetrics.io/docs/usage/docker-pm2-nodejs/
- **Node.js — módulo `cluster`**: https://nodejs.org/api/cluster.html
