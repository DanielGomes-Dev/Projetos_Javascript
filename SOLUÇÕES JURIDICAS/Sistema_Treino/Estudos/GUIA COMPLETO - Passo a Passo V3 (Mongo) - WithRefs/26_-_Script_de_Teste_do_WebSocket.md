...
- **Socket.IO — Client API (`socket.io-client`)**: https://socket.io/docs/v4/client-api/
- **Socket.IO — eventos `connect`/`disconnect`**: https://socket.io/docs/v4/client-socket-instance/#events
