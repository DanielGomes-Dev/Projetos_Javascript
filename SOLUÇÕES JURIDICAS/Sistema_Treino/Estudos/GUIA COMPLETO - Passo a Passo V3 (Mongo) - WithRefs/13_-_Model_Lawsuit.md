...
- **Mongoose — Populate (`ref`, `.populate()`)**: https://mongoosejs.com/docs/populate.html
- **Mongoose — Virtuals**: https://mongoosejs.com/docs/tutorials/virtuals.html
- **Mongoose — `SchemaTypes.ObjectId`**: https://mongoosejs.com/docs/schematypes.html#objectids
