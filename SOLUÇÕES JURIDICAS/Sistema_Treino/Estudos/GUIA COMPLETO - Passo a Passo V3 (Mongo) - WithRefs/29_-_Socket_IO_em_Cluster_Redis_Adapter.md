...
- **Socket.IO — Redis Adapter (`@socket.io/redis-adapter`)**: https://socket.io/docs/v4/redis-adapter/
- **Socket.IO — Usando múltiplos nós (multi-server)**: https://socket.io/docs/v4/using-multiple-nodes/
- **Socket.IO — opção `transports`**: https://socket.io/docs/v4/client-options/#transports
- **ioredis — `.duplicate()`**: https://github.com/redis/ioredis#connect-to-redis
