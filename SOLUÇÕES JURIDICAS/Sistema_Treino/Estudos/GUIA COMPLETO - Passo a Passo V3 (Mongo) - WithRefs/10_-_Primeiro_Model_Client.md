...
- **Mongoose — índices (`unique`, `autoIndex`)**: https://mongoosejs.com/docs/guide.html#indexes
- **Mongoose — `toJSON`/transformações de documentos**: https://mongoosejs.com/docs/api/document.html#Document.prototype.toJSON()
