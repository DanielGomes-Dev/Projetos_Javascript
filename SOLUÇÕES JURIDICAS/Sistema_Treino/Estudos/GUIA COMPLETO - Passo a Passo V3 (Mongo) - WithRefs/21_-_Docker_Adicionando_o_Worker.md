...
- **Docker Compose — `command` (sobrescrevendo o `CMD` da imagem)**: https://docs.docker.com/reference/compose-file/services/#command
- **Docker — volumes anônimos e nomeados**: https://docs.docker.com/engine/storage/volumes/
